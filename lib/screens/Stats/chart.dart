...
List<BarChartGroupData> showingGroups()=> List.generate(8, (i){
  ...
  Widget leftTiles(double value, TitleMeta meta) {
    ...
    if (value == 0) {
      text = 'R1K';
    } else if (value == 1) {  // Changed from 2 to 1
      text = 'R2K';
    } else if (value == 2) {
      text = 'R3K';
    } else if (value == 3) {  // Changed from 2 to 3
      text = 'R4K';
    } else if (value == 4) {  // Changed from 2 to 4
      text = 'R5K';
    } else {
      return Container();
    }
    return SideTitleWidget(
      meta: meta,
      space: 0,
      child: Text(text, style: style),  // Added style
    );
  }
